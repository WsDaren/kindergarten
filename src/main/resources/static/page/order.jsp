    ...
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'oid', width: 150,height: 100, title: 'ID'},
                {field: 'orderno', width: 150, title: '订单编号'},
                {field: 'order_time_str',width: 150, title: '下单时间'},
                {field: 'perple_count', width: 150, title: '出行人数'},
                {field: 'order_desc', width: 150, title: '订单描述'},
                {field: 'pay_type', width: 150, title: '支付类型(0支付宝 1微信)'},
                {field: 'order_status', width: 150, title: '订单状态(0 已支付 1未支付)'},
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                $.ajax({
                    url:'/ssmredisshiro/ofindById.do',
                    type:'post',
                    data:{
                        oid:data.oid
                    },
